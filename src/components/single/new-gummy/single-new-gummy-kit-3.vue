...
<script>
    ...
    import ProdutoGummyKits3 from './components/produto-gummy-kits-3.vue';
    ...
    import MotivosNewHair from '../../gerais/motivos-new-hair/motivos-new-hair.vue';
        ...
        created() {
            this.$requestSend('get', `/v2/front/url/product/detail?url=${this.genPath(this.$route.fullPath)}&offset=0&limit=1`, {}, (success, response) => {
                if (success) {
                    ...
                    response.data.estrutura.seo.canonical = "https://www.newhair.com.br/new-hair-gummy-morango-vitamina-em-goma-para-cabelos-e-unhas.html"
