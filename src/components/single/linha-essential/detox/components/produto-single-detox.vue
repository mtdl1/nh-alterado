            ...
            <div class="row">
                <div class="col-md-7" id="sliderProductSingle" ref="sliderProductSingle">
                    <div id="custCarousel" class="carousel slide d-flex" align="center">
                        ...
                        <div class="carousel-inner" id="carouselInnerSlider">
                            <div class="imagens-plataforma" v-if="sabores == 0">
                                <!-- <img src="@/assets/img/linha-essential/linhas/detox/produtos/kit-completo-detox.jpg" class="img-fluid" alt=""> -->
                            ...
                            <div class="imagens-plataforma" v-if="sabores == 0">
                                <!-- <img src="@/assets/img/linha-essential/linhas/detox/produtos/kit-completo-detox.jpg" class="img-fluid" alt=""> -->
                                <div v-if="kitPotes == 'KITSERUMREPARADOR'">
                    ...
                    <div class="desk">
                        ...
                        <BeneficiosEssentialSingle nomeLinha="SGSuperDetox" />
                    </div>
                </div>
                ...
                <div class="col-md-5" id="InfoProduto">
                    ...
                    <div class="descricao mb-4">
                        <div class="item-desc pb-1 d-flex align-items-center" v-for="(topico, index) in topicos" :key="index">
                            <img class="mr-1" src="@/assets/img/single/selecionado-detox.png" alt="" />
                            <p>{{topico}}</p>
                        </div>
                    </div>
                    ...
                    <!-- Kit Serum Reparador -->
                    <div class="prices" v-if="kitPotes == 'KITSERUMREPARADOR'">
                        <p class="priceOld"> <s> {{ saboresKit.kitserumreparador.precosGerais.precoDe.toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' }) }} </s> </p>
                        <div class="d-flex align-items-center justify-content-between">
                            <p class="currentPrice"> <strong>{{ (saboresKit.kitserumreparador.precosGerais.precoPor).toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' }) }}</strong> </p>
                            <p class="discount"> ECONOMIZE <br> <strong> {{ (saboresKit.kitserumreparador.precosGerais.precoDe - saboresKit.kitserumreparador.precosGerais.precoPor).toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' }) }} </strong></p>
                        </div>
                        <div class="d-flex align-items-center mt-3 mb-2">
                            <p class="priceNew">Ou 8x de <strong> {{ (saboresKit.kitserumreparador.precosGerais.precoPor/8).toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' }) }}</strong> </p>
                        </div>
                    </div>
                    ...
                    <div class="group-kits my-3">
                        ...
                        <form>
                            <label class="check-label w-100 d-flex align-items-center my-2 position-relative " for="kit2Potes" @click="changeKit($event), idLista = 152">
                                <div class="kit-potes d-flex align-items-center">
                                    ...
                                    <div class="d-flex flex-column">
                                        <p class="name-kit"> Kit Completo Super Detox</p>
                                        <p class="description-kit">Shampoo, condicionador e Serúm</p>
                                    </div>
                                </div>
                            ...
                            <label class="check-label w-100 d-flex align-items-center my-2 position-relative" for="kit1" @click="changeKit($event), idLista = 153"> 
                                <div class="kit-potes d-flex align-items-center">
                                    <div class="circ-select">
                                        <input class="check-input mx-3" type="radio" id="kit1" name="kit" value="KITBASICO" v-model="kitPotes">
                                    </div>
                                    <div class="d-flex flex-column">
                                        <p class="name-kit"> Essential Super Detox</p>
                            ...
                            <label class="check-label w-100 d-flex align-items-center my-2" for="kitserumreparador" @click="changeKit($event), idLista = 156"> 
                                <div class="kit-potes d-flex align-items-center">
                                    <div class="circ-select">
                                        <input class="check-input mx-3" type="radio" id="kitserumreparador" name="kit" value="KITSERUMREPARADOR" v-model="kitPotes">
                                    </div>
                                    <div class="d-flex flex-column">
                                        <p class="name-kit">Sérum Reparador de Pontas Super Detox</p>
                                    </div>
                                </div>
                            </label>

                            <label class="check-label w-100 d-flex align-items-center my-2 position-relative" for="kitshampoo" @click="changeKit($event), idLista = 154">
                                <div class="kit-potes d-flex align-items-center">
                                    <div class="circ-select">
                                        <input class="check-input mx-3" type="radio" id="kitshampoo" name="kit" value="KITSHAMPOO" v-model="kitPotes">
                                    </div>
                                    <div class="d-flex flex-column">
                                        <p class="name-kit">Shampoo Super Detox</p>
                                    </div>
                                </div>
                            </label>
                            <label class="check-label w-100 d-flex align-items-center my-2 position-relative" for="kitcondicionador" @click="changeKit($event), idLista = 155">
                                <div class="kit-potes d-flex align-items-center">
                                    <div class="circ-select">
                                        <input class="check-input mx-3" type="radio" id="kitcondicionador" name="kit" value="KITCONDICIONADOR" v-model="kitPotes">
                                    </div>
                                    <div class="d-flex flex-column">
                                        <p class="name-kit">Condicionador Super Detox</p>
                                    </div>
                                </div>
                            </label>
                        </form>
     ...
     props: {
        ...
        data() {
            return {
                ...
                nome: 'Home Care Essential - Super Detox',
                breadcrumb: '',
                galeriaImagens: [],
                precoDe: '0',
                precoPor: 0,
                ...
                topicos: {
                    1: 'Extrato de gengibre, café e malaleuca, menta;',
                    2: 'Limpeza profunda e maciez;',
                    3: 'PH equilibrado;',
                    4: 'Refrescância e brilho.',
                },
                saboresKit: {
                    kit1: {
                        precosGerais: {
...
<style scoped>
    ...
    input[type="radio"]:checked {
        background-color: #9FBD3E;
        border: 5px solid white !important;
    }

    .selecionado {
        background: #F6FBE7 0% 0% no-repeat padding-box;
        border: 1px solid #9FBD3E !important;
    }

    .selecionado .circ-select {
        border: 1px solid #9FBD3E;
    }
