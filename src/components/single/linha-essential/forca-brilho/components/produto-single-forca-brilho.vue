            ...
            <div class="row">
                <div class="col-md-7" id="sliderProductSingle" ref="sliderProductSingle">
                        ...
                        <div class="carousel-inner" id="carouselInnerSlider">
                            <div class="imagens-plataforma" v-if="sabores == 0">
                                <div v-if="kitPotes == 'KITCOMPLETO'">
                                     <!-- <img src="@/assets/img/linha-essential/linhas/forca-brilho/produtos/kit-completo-forca-brilho.jpg" class="img-fluid" alt=""> -->
                                ...
                                <div class="carousel-item active" v-if="kitPotes == 'KITBASICO'"> 
                                    ...
                                    <!-- <img src="@/assets/img/linha-essential/linhas/forca-brilho/produtos/kit-basico-forca-brilho.jpg" class="img-fluid" alt=""> -->
                                </div>
                                <div class="carousel-item active" v-if="kitPotes == 'KITMASCARA'"> 
                                    <div v-for="(imagem, index) in galeriaImagens" :key="index" :class="['carousel-item',{active: index==7}]" > 
                                        <img :src="imagem.arquivos.big" class="img-fluid" alt="">
                                    </div>
                                    <!-- <img src="@/assets/img/linha-essential/linhas/forca-brilho/produtos/forca-brilho-mascara.jpg" class="img-fluid" alt=""> -->
                                </div>
                                <div class="carousel-item active" v-if="kitPotes == 'KITSERUM'">
                                    ...
                                    <!-- <img src="@/assets/img/linha-essential/linhas/forca-brilho/produtos/forca-brilho-serum-reparador.jpg" class="img-fluid" alt=""> -->
                                </div>
                                <div class="carousel-item active" v-if="kitPotes == 'KITSHAMPOO'"> 
                                    ...
                                    <!-- <img src="@/assets/img/linha-essential/linhas/forca-brilho/produtos/forca-brilho-shampoo.jpg" class="img-fluid" alt=""> -->
                                </div>
                                <div class="carousel-item active" v-if="kitPotes == 'KITCONDICIONADOR'"> 
                                    ...
                                    <!-- <img src="@/assets/img/linha-essential/linhas/forca-brilho/produtos/forca-brilho-condicionador.jpg" class="img-fluid" alt=""> -->
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="desk">
                        ...
                        <BeneficiosEssentialSingle nomeLinha="SGForcaBrilho"/>
                    </div>
                </div>
                ...
                <div class="col-md-5" id="InfoProduto">
                    ...
                    <div class="descricao mb-4">
                        <div class="item-desc pb-1 d-flex align-items-center" v-for="(topico, index) in topicos" :key="index">
                            <img class="mr-1" src="@/assets/img/single/selecionado-forca.png" alt="" />
                            <p>{{topico}}</p>
                        </div>
                    </div>
                    ...
                    <div class="group-kits my-3">
                        ...
                        <form>
                            <label class="check-label w-100 d-flex align-items-center my-2 position-relative " for="kit2Potes" @click="changeKit($event), idLista = 147">
                                <div class="kit-potes d-flex align-items-center">
                                    ...
                                    <div class="d-flex flex-column">
                                        <p class="name-kit"> Kit Completo Força e Brilho</p>
                                        <p class="description-kit">Shampoo, condicionador, máscara e serúm</p>
                                    </div>
                                </div>
                            ...
                            <label class="check-label w-100 d-flex align-items-center my-2 position-relative" for="kit1" @click="changeKit($event), idLista = 148"> 
                                <div class="kit-potes d-flex align-items-center">
                                    <div class="circ-select">
                                        <input class="check-input mx-3" type="radio" id="kit1" name="kit" value="KITBASICO" v-model="kitPotes">
                                    </div>
                                    <div class="d-flex flex-column">
                                        <p class="name-kit"> Essential Força e Brilho</p>
                            ...
                            <label class="check-label w-100 d-flex align-items-center my-2 position-relative" for="kitmascara" @click="changeKit($event), idLista = 151">
                                <div class="kit-potes d-flex align-items-center">
                                    <div class="circ-select">
                                        <input class="check-input mx-3" type="radio" id="kitmascara" name="kit" value="KITMASCARA" v-model="kitPotes">
                                    </div>
                                    <div class="d-flex flex-column">
                                        <p class="name-kit">Máscara Força e Brilho</p>
                                    </div>
                                </div>
                            </label>
                            <label class="check-label w-100 d-flex align-items-center my-2 position-relative" for="kitserum" @click="changeKit($event), idLista = 162">
                                <div class="kit-potes d-flex align-items-center">
                                    <div class="circ-select">
                                        <input class="check-input mx-3" type="radio" id="kitserum" name="kit" value="KITSERUM" v-model="kitPotes">
                                    </div>
                                    <div class="d-flex flex-column">
                                        <p class="name-kit">Sérum Reparador de Pontas Força e Brilho</p>
                                    </div>
                                </div>
                            </label>
                            <label class="check-label w-100 d-flex align-items-center my-2 position-relative" for="kitshampoo" @click="changeKit($event), idLista = 149">
                                <div class="kit-potes d-flex align-items-center">
                                    <div class="circ-select">
                                        <input class="check-input mx-3" type="radio" id="kitshampoo" name="kit" value="KITSHAMPOO" v-model="kitPotes">
                                    </div>
                                    <div class="d-flex flex-column">
                                        <p class="name-kit">Shampoo Força e Brilho</p>
                                    </div>
                                </div>
                            </label>
                            <label class="check-label w-100 d-flex align-items-center my-2 position-relative" for="kitcondicionador" @click="changeKit($event), idLista = 150">
                                <div class="kit-potes d-flex align-items-center">
                                    <div class="circ-select">
                                        <input class="check-input mx-3" type="radio" id="kitcondicionador" name="kit" value="KITCONDICIONADOR" v-model="kitPotes">
                                    </div>
                                    <div class="d-flex flex-column">
                                        <p class="name-kit">Condicionador Força e Brilho</p>
                                    </div>
                                </div>
                            </label>
                        </form>
     ...
     props: {
        ...
        data() {
            return {
                ...
                nome: 'Home Care Essential - Força e Brilho',
                breadcrumb: '',
                galeriaImagens: [],
                precoDe: '0',
                precoPor: 0,
                ...
                topicos: {
                    1: 'Óleo de coco, biotina, aloe vera',
                    2: 'Força e resistência extrema',
                    3: 'Brilho e maciez intensos',
                    4: 'Balanço natural',
                },
                saboresKit: {
                    kit1: {
...
<style scoped>
    ...
    .selecionado {
        background: #D5F9FF 0% 0% no-repeat padding-box;
        border: 1px solid #35BCD1 !important;
    }

    .selecionado .circ-select {
        border: 1px solid #35BCD1;
    }
