  ...
  <section class="produtoSingle" id="produtos">
      ...
      <div class="row">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb mb-1">
            ...
            <li class="breadcrumb-item active pink" id="breadcrumbTitle" aria-current="page" v-html="breadcrumb"
            ></li>
          </ol>
        </nav>
      </div>
    ...
    <div class="container">
      <div class="row">
        <div
          class="col-md-7"
          id="sliderProductSingle"
          ref="sliderProductSingle"
        >
          <div id="custCarousel" class="carousel slide d-flex" align="center">
            ...
            <div class="overflowThumbs">
              <div class="desk">
                <ol class="list-group carousel-indicators thumbs d-flex">
                  <li
                    v-for="(imagem, index) in galeriaImagens"
                    :key="index"
            ...
            <div class="desk">
              <a
                class="thumb-controls cima"
                href="#custCarousel"
                data-slide="prev"
                ><i class="fas fa-chevron-up"></i
              ></a>
              <a
                class="thumb-controls baixo"
                href="#custCarousel"
                data-slide="next"
            ...
            <div class="mob">
              <a
                class="thumb-controls left cimaMob"
                href="#custCarousel"
                data-slide="prev"
                ><i class="fas fa-chevron-up"></i
              ></a>
              <a
                class="thumb-controls right baixoMob"
                href="#custCarousel"
                data-slide="next"
                ><i class="fas fa-chevron-down"></i
              ></a>
            ...
            <div class="carousel-inner" id="carouselInnerSlider">
              <div class="imagens-plataforma" v-if="sabores == 0">
                <div v-if="kitPotes == 'KITCOMPLETO'">
                   <!-- <img
                    src="@/assets/img/linha-essential/linhas/sos-reparacao/produtos/linha sos kit.jpg"
                    class="img-fluid"
                    alt=""
                  /> -->
                  <div
                ...
                <div v-if="kitPotes == 'KITBASICO'">
                  ...
                  <div
                    v-for="(imagem, index) in galeriaImagens"
                    :key="index"
                    :class="['carousel-item', { active: index == 4 }]"
                  >
                    <img :src="imagem.arquivos.big" class="img-fluid" alt="" />
                  </div>
                </div>
                <div v-if="kitPotes == 'KITMASCARA'">
                   <!-- <img
                    src="@/assets/img/linha-essential/linhas/sos-reparacao/produtos/linha sos kit.jpg"
                    class="img-fluid"
                    alt=""
                  ...
                  <div
                    v-for="(imagem, index) in galeriaImagens"
                    :key="index"
                    :class="['carousel-item', { active: index == 7 }]"
                  >
                    <img :src="imagem.arquivos.big" class="img-fluid" alt="" />
                  </div>
                </div>
                <div v-if="kitPotes == 'KITSHAMPOO'">
                   <!-- <img
                    src="@/assets/img/linha-essential/linhas/sos-reparacao/produtos/linha sos kit.jpg"
                    class="img-fluid"
                    alt=""
                  ...
                  <div
                    v-for="(imagem, index) in galeriaImagens"
                    :key="index"
                    :class="['carousel-item', { active: index == 5 }]"
                  >
                    <img :src="imagem.arquivos.big" class="img-fluid" alt="" />
                  </div>
                </div>
                <div v-if="kitPotes == 'KITCONDICIONADOR'">
                   <!-- <img
                    src="@/assets/img/linha-essential/linhas/sos-reparacao/produtos/linha sos kit.jpg"
                    class="img-fluid"
                    alt=""
                  ...
                  <div
                    v-for="(imagem, index) in galeriaImagens"
                    :key="index"
                    :class="['carousel-item', { active: index == 6 }]"
                  >
                    <img :src="imagem.arquivos.big" class="img-fluid" alt="" />
                  </div>
                </div>
          ...
          <div class="desk">
            <div class="d-flex align-items-center justify-content-between mb-4">
              <img
                class="img-fluid"
                src="@/assets/img/single/linha-essential/icones/selos/google-safe.png"
                alt="Compra segura"
              />
              <img
                class="img-fluid"
                src="@/assets/img/single/linha-essential/icones/selos/compra-Segura.svg"
                alt="Compra segura"
              />
              <img
                class="img-fluid"
                src="@/assets/img/single/linha-essential/icones/selos/premium-Quality.svg"
                alt="Compra segura"
              />
            </div>
            <BeneficiosEssentialSingle nomeLinha="SGSReparacao" />
          </div>
        </div>
        ...
        <div class="col-md-5" id="InfoProduto">
          ...
          <div class="descricao mb-4">
            <div
              class="item-desc pb-1 d-flex align-items-center"
              v-for="(topico, index) in topicos"
              :key="index"
            >
              <img
                class="mr-1"
                src="@/assets/img/single/selecionado-sos.png"
                alt=""
              />
              <p>{{ topico }}</p>
            </div>
          ...
          <div class="prices" v-if="kitPotes == 'KITCOMPLETO'">
            <p class="priceOld">
              <s>
                {{
                  saboresKit.kit2.precosGerais.precoDe.toLocaleString("pt-BR", {
                    style: "currency",
                    currency: "BRL",
                  })
                }}
            ...
            <div class="d-flex align-items-center justify-content-between">
              <p class="currentPrice">
                <strong>
                  {{
                    saboresKit.kit2.precosGerais.precoPor.toLocaleString(
                      "pt-BR",
              ...
              <p class="discount text-right">
                ECONOMIZE <br />
                <strong>
                  {{
                    (
                      saboresKit.kit2.precosGerais.precoDe -
                      saboresKit.kit2.precosGerais.precoPor
            ...
            <div class="d-flex align-items-center mt-3 mb-2">
              <p class="priceNew">
                ...
                <strong>
                  {{
                    (saboresKit.kit2.precosGerais.precoPor / 8).toLocaleString(
                      "pt-BR",
                      { style: "currency", currency: "BRL" }
                    )
                  }}</strong
          ...
          <div class="prices" v-if="kitPotes == 'KITBASICO'">
            <p class="priceOld">
              <s>
                {{
                  saboresKit.kit1.precosGerais.precoDe.toLocaleString("pt-BR", {
                    style: "currency",
                    currency: "BRL",
                  })
                }}
            ...
            <div class="d-flex align-items-center justify-content-between">
              <p class="currentPrice">
                <strong>{{
                  saboresKit.kit1.precosGerais.precoPor.toLocaleString(
                    "pt-BR",
                    { style: "currency", currency: "BRL" }
                  )
                }}</strong>
              ...
              <p class="discount">
                ...
                <strong>
                  {{
                    (
                      saboresKit.kit1.precosGerais.precoDe -
                      saboresKit.kit1.precosGerais.precoPor
                    ).toLocaleString("pt-BR", {
                      style: "currency",
                      currency: "BRL",
                    })
            ...
            <div class="d-flex align-items-center mt-3 mb-2">
              <p class="priceNew">
                ...
                <strong>
                  {{
                    (saboresKit.kit1.precosGerais.precoPor / 8).toLocaleString(
                      "pt-BR",
                      { style: "currency", currency: "BRL" }
                    )
                  }}</strong
          ...
          <!-- Mascara 1 pote -->
          <div class="prices" v-if="kitPotes == 'KITMASCARA'">
            <p class="priceOld">
              <s>
                {{
                  saboresKit.kitmascara.precosGerais.precoDe.toLocaleString(
                    "pt-BR",
                    { style: "currency", currency: "BRL" }
                  )
                }}
            ...
            <div class="d-flex align-items-center justify-content-between">
              <p class="currentPrice">
                <strong>{{
                  saboresKit.kitmascara.precosGerais.precoPor.toLocaleString(
                    "pt-BR",
                    { style: "currency", currency: "BRL" }
                  )
                }}</strong>
              ...
              <p class="discount">
                ...
                <strong>
                  {{
                    (
                      saboresKit.kitmascara.precosGerais.precoDe -
                      saboresKit.kitmascara.precosGerais.precoPor
                    ).toLocaleString("pt-BR", {
                      style: "currency",
                      currency: "BRL",
                    })
            ...
            <div class="d-flex align-items-center mt-3 mb-2">
              <p class="priceNew">
                ...
                <strong>
                  {{
                    (
                      saboresKit.kitmascara.precosGerais.precoPor / 8
                    ).toLocaleString("pt-BR", {
                      style: "currency",
                      currency: "BRL",
                    })
          ...
          <div class="prices" v-if="kitPotes == 'KITSHAMPOO'">
            <p class="priceOld">
              <s>
                {{
                  saboresKit.kitshampoo.precosGerais.precoDe.toLocaleString(
                    "pt-BR",
                    { style: "currency", currency: "BRL" }
                  )
                }}
            ...
            <div class="d-flex align-items-center justify-content-between">
              <p class="currentPrice">
                <strong>{{
                  saboresKit.kitshampoo.precosGerais.precoPor.toLocaleString(
                    "pt-BR",
                    { style: "currency", currency: "BRL" }
                  )
                }}</strong>
              ...
              <p class="discount">
                ...
                <strong>
                  {{
                    (
                      saboresKit.kitshampoo.precosGerais.precoDe -
                      saboresKit.kitshampoo.precosGerais.precoPor
                    ).toLocaleString("pt-BR", {
                      style: "currency",
                      currency: "BRL",
                    })
            ...
            <div class="d-flex align-items-center mt-3 mb-2">
              <p class="priceNew">
                ...
                <strong>
                  {{
                    (
                      saboresKit.kitshampoo.precosGerais.precoPor / 8
                    ).toLocaleString("pt-BR", {
                      style: "currency",
                      currency: "BRL",
                    })
          ...
          <div class="prices" v-if="kitPotes == 'KITCONDICIONADOR'">
            <p class="priceOld">
              <s>
                {{
                  saboresKit.kitcondicionador.precosGerais.precoDe.toLocaleString(
                    "pt-BR",
                    { style: "currency", currency: "BRL" }
                  )
                }}
            ...
            <div class="d-flex align-items-center justify-content-between">
              <p class="currentPrice">
                <strong>{{
                  saboresKit.kitcondicionador.precosGerais.precoPor.toLocaleString(
                    "pt-BR",
                    { style: "currency", currency: "BRL" }
                  )
                }}</strong>
              ...
              <p class="discount">
                ...
                <strong>
                  {{
                    (
                      saboresKit.kitcondicionador.precosGerais.precoDe -
                      saboresKit.kitcondicionador.precosGerais.precoPor
                    ).toLocaleString("pt-BR", {
                      style: "currency",
                      currency: "BRL",
                    })
            ...
            <div class="d-flex align-items-center mt-3 mb-2">
              <p class="priceNew">
                ...
                <strong>
                  {{
                    (
                      saboresKit.kitcondicionador.precosGerais.precoPor / 8
                    ).toLocaleString("pt-BR", {
                      style: "currency",
                      currency: "BRL",
                    })
          ...
          <div class="group-kits my-3">
            ...
            <form>
              <label
                class="check-label w-100 d-flex align-items-center my-2 position-relative"
                for="kit2Potes"
                @click="changeKit($event), (idLista = 129)"
              >
                <div class="kit-potes d-flex align-items-center">
                  <div class="circ-select">
                    <input
                      class="check-input mx-3"
                      type="radio"
                      id="kit2Potes"
                      name="kit"
                      value="KITCOMPLETO"
                  ...
                  <div class="d-flex flex-column">
                    <p class="name-kit">
                      Kit Completo <br class="mob" />
                      SOS Reparação
                    </p>
                    <p class="description-kit">
                ...
                <div class="position-absolute box-infos kit1">
                  <div class="desconto-kit position-relative">
                    {{
                      Math.floor(
                        100 -
                          (saboresKit.kit2.precosGerais.precoPor * 100) /
                            saboresKit.kit2.precosGerais.precoDe
                      )
                    }}% OFF
                  </div>
              ...
              <label
                class="check-label w-100 d-flex align-items-center my-2 position-relative"
                for="kit1"
                @click="changeKit($event), (idLista = 128)"
              >
                <div class="kit-potes d-flex align-items-center">
                  <div class="circ-select">
                    <input
                  ...
                  <div class="d-flex flex-column">
                    <p class="name-kit">Essential SOS Reparação</p>
                ...
                <div class="position-absolute box-infos kit1">
                  <div class="desconto-kit position-relative">
                    {{
                      Math.floor(
                        100 -
                          (saboresKit.kit1.precosGerais.precoPor * 100) /
                            saboresKit.kit1.precosGerais.precoDe
                      )
                    }}% OFF
                  </div>
              ...
              <label
                class="check-label w-100 d-flex align-items-center my-2 position-relative"
                for="kitmascara"
                @click="changeKit($event), (idLista = 127)"
              >
                <div class="kit-potes d-flex align-items-center">
                  <div class="circ-select">
                    <input
                  ...
                  <div class="d-flex flex-column">
                    <p class="name-kit">Máscara SOS Reparação</p>
                  </div>
                </div>
              </label>
              <label
                class="check-label w-100 d-flex align-items-center my-2 position-relative"
                for="kitshampoo"
                @click="changeKit($event), (idLista = 125)"
              >
                <div class="kit-potes d-flex align-items-center">
                  <div class="circ-select">
                    <input
                  ...
                  <div class="d-flex flex-column">
                    <p class="name-kit">Shampoo SOS Reparação</p>
                  </div>
                </div>
              </label>
              <label
                class="check-label w-100 d-flex align-items-center my-2 position-relative"
                for="kitcondicionador"
                @click="changeKit($event), (idLista = 126)"
              >
                <div class="kit-potes d-flex align-items-center">
                  <div class="circ-select">
                    <input
                      ...
                      id="kitcondicionador"
                      name="kit"
                      value="KITCONDICIONADOR"
                      v-model="kitPotes"
                    />
                  </div>
                  <div class="d-flex flex-column">
                    <p class="name-kit">Condicionador SOS Reparação</p>
                  </div>
                </div>
              </label>
            </form>
          ...
          <div class="btn btn-primary btn-lg green" @click="addCartBoxCompra()">
            COMPRE AGORA
          </div>
          <div class="mob">
            <div class="d-flex align-items-center justify-content-between pt-4">
              <img
                class="img-fluid"
                src="@/assets/img/single/SELOS.png"
                alt="Compra segura"
              />
            </div>
          </div>
...
$(function () {
  setTimeout(function () {
    ...
    var height =
      parseInt($(".carousel .list-group .list-inline-item").outerHeight()) *
      qtdImages; //Calcula altura da coluna de Thumbs
    ...
    var slide =
      numImages * marginPadding +
      $(".carousel .list-group .list-inline-item").outerHeight() * numImages; // Tamanho do Slide (quanto de margin pode avançar)
...
export default {
  ...
  data() {
    return {
      ...
      nome: "Home Care Essential - SOS Reparação",
      breadcrumb: "",
      galeriaImagens: [],
      precoDe: "0",
      precoPor: 0,
      ...
      topicos: {
        1: "Queratina, arginina e blend de óleos especiais;",
        2: "Regeneração de dentro para fora;",
        3: "Proteção e reparação extrema;",
        4: "Restauração e nutrição intensas.",
      },
      saboresKit: {
        kit1: {
          precosGerais: {
      ...
      if (tipo && itens) {
        ...
        this.$carrinho.add(tipo, itens, (success, response) => {
          ...
          if (success) {
            ...
            return Comunicacao.$emit("toggleCarrinho", {
              show: true,
              data: response.data,
            });
          }
  ...
  created() {
    ...
    this.$requestSend(
      "get",
      `/v2/front/url/product/detail?url=${this.genPath(
        this.$route.fullPath
      )}&offset=0&limit=1`,
      {},
      (success, response) => {
...
.selecionado {
  background: #fbe4ec 0% 0% no-repeat padding-box;
