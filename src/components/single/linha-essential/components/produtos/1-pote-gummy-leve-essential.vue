<template>
    <div class="card">
        <div class="img-card position-relative">
            <img id="94" v-if="sabores == 91 || sabores == 0" class="img-fluid" src="@/assets/img/novas-gomas/single/gomas/01/NEW_HAIR_GUMMY_MORANGO_FRESH.jpg" alt="1 Pote Gummy Morango">
            <img id="93" v-if="sabores == 89" class="img-fluid" src="@/assets/img/novas-gomas/single/gomas/01/NEW_HAIR_GUMMY_UVA_VERDE.jpg">
            <img id="90" v-if="sabores == 87" class="img-fluid" src="@/assets/img/novas-gomas/single/gomas/01/NEW_HAIR_GUMMY_LARANJA_1.jpg">
            <div class="position-absolute desconto"> {{ (Math.floor(100 - (precoPor*100)/precoDe)) }}% OFF </div>
        </div>
        <div class="card-body">
            <div class="body-title">
                <h5 class="card-title">1 Pote New Hair Gummy</h5>
            ...
            <div class="form-group select_sabores w-100 pr-3 my-1">
                <select name="saboresColagProd3" class="select_option browser-default custom-select" id="saboresColagProd3" @change="onChange($event)" v-model="sabores">
                    ...
                    <option class="option" value="91">Morango</option>
                    <option class="option" value="89">Uva Verde</option>
                    <option class="option" value="87">Laranja</option>
                </select>
            </div>
            <!-- <div>
                <a href="/new-hair-gummy-morango-vitamina-em-goma-para-cabelos-e-unhas.html" class="btn-compra">Saiba mais</a>
            </div> -->
