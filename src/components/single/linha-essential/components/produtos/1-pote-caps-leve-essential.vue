<template>
    <div class="card">
        <div class="img-card position-relative">
            <a href="/new-hair-gummy-morango-vitamina-em-goma-para-cabelos-e-unhas.html">
                <img class="card-img-top" src="@/assets/img/produtos/caps/1 Pote New Hair Caps.jpg" alt="Kit completo sos reparacao">
            </a>
            <div class="position-absolute desconto"> {{ (Math.floor(100 - (precoPor*100)/precoDe)) }}% OFF </div>
        </div>
        <div class="card-body">
            <div class="body-title">
                <h5 class="card-title">1 Pote New Hair Caps</h5>
                    ...
                    this.$carrinho.add(tipo,itens,(success, response) => {
                        ...
                        if(success){
                            this.$fbAddToCart({ 
                                ...
                                currentProduct: '1 Pote New Hair Caps', 
