<template>
    <div class="card">
        <div class="img-card position-relative">
                <img class="card-img-top" src="@/assets/img/produtos/caps/3-Potes-New-Hair-Caps-+-brinde-massageador.jpg" alt="Kit completo sos reparacao">
            <div class="position-absolute desconto"> {{ (Math.floor(100 - (precoPor*100)/precoDe)) }}% OFF </div>
        </div>
        <div class="card-body">
            <div class="body-title">
                <h5 class="card-title">3 Potes New Hair Caps</h5>
