<template>
    <div class="card">
        <div class="img-card position-relative">
            <img id="94" v-if="sabores == 94 || sabores == 0" class="img-fluid" src="@/assets/img/produtos/gomas/kit-3/home/3 Potes New Hair Gummy + mascara.jpg" alt="3 Potes Gummy Uva - Laranja - Morango" title="3 Potes Gummy Uva - Laranja - Morango">
            <img id="93" v-if="sabores == 93" class="img-fluid" src="@/assets/img/produtos/gomas/kit-3/home/3 Potes New Hair Gummy  morango + mascara.jpg" alt="3 Potes Gummy Morango - Morango - Morango" title="3 Potes Gummy Morango - Morango - Morango">
            <img id="90" v-if="sabores == 90" class="img-fluid" src="@/assets/img/produtos/gomas/kit-3/home/3 Potes New Hair Gummy VERDE + mascara.jpg" alt="3 Potes Gummy Uva Verde" title="3 Potes Gummy Uva Verde">
            <img id="88" v-if="sabores == 88" class="img-fluid" src="@/assets/img/produtos/gomas/kit-3/home/3 Potes New Hair Gummy LARANJA + mascara.jpg" alt="3 Potes Gummy Laranja" title="3 Potes Gummy Laranja">
            <div class="position-absolute desconto"> {{ (Math.floor(100 - (precoPor*100)/precoDe)) }}% OFF </div>
        </div>
        <div class="card-body">
            <div class="body-title">
                <h5 class="card-title">3 Potes New Hair Gummy</h5>
            ...
            <div class="form-group select_sabores w-100 pr-3 my-1">
                <select name="saboresColagProd3" class="select_option browser-default custom-select" id="saboresColagProd3" @change="onChange($event)" v-model="sabores">
                    ...
                    <option class="option" value="94">3 Potes Gummy Uva - Laranja - Morango</option>
                    <option class="option" value="93">3 Potes - Morango</option>
                    <option class="option" value="90">3 Potes - Uva Verde</option>
                    <option class="option" value="88">3 Potes - Laranja</option>
                </select>
            </div>
            <button class="btn-compra" @click="addCartBoxCompra();">ADICIONAR AO CARRINHO</button>
        </div>
    </div>
</template>
