        ...
        <div class="container">
            <div class="row">
                <div class="col-md-7" id="sliderProductSingle" ref="sliderProductSingle">
                    ...
                    <div class="selos">
                      <img src="@/assets/img/icones/selos/google-safe.png" alt="">
                      <img src="@/assets/img/icones/selos/compra-Segura.svg" alt="">
                      <img src="@/assets/img/icones/selos/premium-Quality.svg" alt="">
                    </div>
                </div>
                ...
                <div class="col-md-5" id="InfoProduto">
                    ...
                    <div class="qualidades-produto">
                      <div class="qualidade">
                        ...
                        <p>Resultados de salão em poucos minutos</p>
                      </div>
                      <div class="qualidade">
                        <img src="@/assets/img/novas-gomas/single/icones/qualidade-gummy.png" alt="" />
                        <p>Tecnologia com placas em cerâmica ionizadaais</p>
                      </div>
                      <div class="qualidade">
                        <img src="@/assets/img/novas-gomas/single/icones/qualidade-gummy.png" alt="" />
                        <p>Fios lisos da raiz às pontas sem queimaduras</p>
                      </div>
                      <div class="qualidade">
                        <img src="@/assets/img/novas-gomas/single/icones/qualidade-gummy.png" alt="" />
                        <p>Temperatura ajustável para todos os tipos de cabelos</p>
                      </div>
                      <div class="qualidade">
                        <img src="@/assets/img/novas-gomas/single/icones/qualidade-gummy.png" alt="" />
                        <p>Quatro passos para fios impecáveis</p>
                      </div>
                      <div class="qualidade">
                        <img src="@/assets/img/novas-gomas/single/icones/qualidade-gummy.png" alt="" />
                        <p>Design anatômico e seguro antiderrapante</p>
                      </div>
                      <div class="qualidade">
                        <img src="@/assets/img/novas-gomas/single/icones/qualidade-gummy.png" alt="" />
                        <p>Modela sem marcar e elimina o frizz</p>
                      </div>
                    </div>
                    ...
                    <div class="prices">
                        <div class="d-flex align-items-center justify-content-between">
                            <p class="priceOld">
                                <s>{{(precoDe).toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' }) }}</s>
                            </p>
                            <p class="discount"> <strong>ECONOMIZE
                                    {{(precoDe - precoPor).toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' }) }}</strong>
                            </p>
                        </div>
                        ...
                        <div class="d-flex align-items-center">
                            <p class="priceNew">Ou 8x de
                                <strong>{{(precoPor/8).toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' }) }}</strong>
                            </p>
                        </div>
                    </div>

                    <div class="btn btn-primary btn-lg green my-4" @click="addCartBoxCompra()">COMPRE AGORA</div>
                    <!-- <div class="btn btn-primary btn-lg green mt-2 inputDisable">ESGOTADO</div> -->

                    <p class="cores-escova">*As cores da escova alisadora são sortidas e enviadas aleatoriamente sem possibilidade de escolha ou troca.</p>
                </div>
    ...
    export default {
        data() {
            return {
                ...
                nome: 'New Hair Escova Alisadora',
                descricaoProduto: 'Cabelos Lisos e Saudáveis',
                galeriaImagens: [],
                precoDe: 299.90,
                precoPor: 199.90,
