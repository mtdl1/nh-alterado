    ...
    <header class="desk">
        <a :href="linkTarja">
            <video autoplay muted loop playsinline>
                <source src="@/assets/img/banners/home/desk/Mes-do-Cliente-New-Hair-Masculino-Desktop.mp4" type="video/mp4">
            </video>
        </a>
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            if (window.location.href.indexOf("/produtos-masculino") > -1) {
