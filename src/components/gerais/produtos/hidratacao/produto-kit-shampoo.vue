<template>
	<div class="box-produto mb-3 border-black">
		<div class="header-produto nome-produto d-flex flex-column justify-content-center bgTitle">
			<h2>Kit New Hair</h2>
			<p>Máscara Capilar + Shampoo + Condicionador</p>
		</div>
		<div class="body-produto d-flex">
			<div class="col-produto w-50 d-flex justify-content-center align-items-center position-relative">
				<div class="d-flex">
					<img id="57" class="img-fluid mt-2" src="@/assets/img/produtos/Kit-shampoo-e-mascara.png" alt="Kit New Hair com Máscara Capilar, Shampoo e Condicionador" title="Kit New Hair com Máscara Capilar, Shampoo e Condicionador" />
				</div>
			</div>
			<div class="col-produto w-50 pl-2 d-flex flex-column justify-content-between ">
				...
				<div class="mb-2">
					...
					<div class="mt-2 pr-3">
						...
						<button class="add-to-cart mb-2 w-100 inputDisable">ESGOTADO</button>
					</div>
				</div>
			</div>
		</div>
