<template>
	<div class="box-produto mb-3 border-black">
		<div class="header-produto nome-produto d-flex flex-column justify-content-center bgTitle">
			<h2>Kit Completo Pós Química</h2>
			<p>Cabelos mais resistentes</p>
		</div>
		<div class="body-produto d-flex">
			<div class="col-produto w-50 d-flex justify-content-center align-items-center position-relative">
				<div class="d-flex">
					<img class="img-fluid" src="@/assets/img/produtos/linha-essential/pós quimica kit completo.jpg" alt="1 Pote New Hair Cápsula Feminina" title="1 Pote New Hair Cápsula Feminina" />
				</div>
			</div>
