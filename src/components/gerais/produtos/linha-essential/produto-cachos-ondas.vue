<template>
	<div class="box-produto mb-3 border-black">
		<div class="header-produto nome-produto d-flex flex-column justify-content-center bgTitle">
			<h2>Kit Completo Cachos e Ondas</h2>
			<p>Cachos e ondas livres, leves e soltos</p>
		</div>
		<div class="body-produto d-flex">
			<div class="col-produto w-50 d-flex justify-content-center align-items-center position-relative">
				<div class="d-flex">
					<img class="img-fluid" src="@/assets/img/produtos/linha-essential/CACHOS E ONDAS KIT.jpg" alt="1 Pote New Hair Cápsula Feminina" title="1 Pote New Hair Cápsula Feminina" />
				</div>
			</div>
                    ...
                    this.$carrinho.add(tipo,itens,(success, response) => {
                        ...
                        if(success){
													this.$fbAddToCart({ 
														...
														currentProduct: 'Kit Completo Cachos e Ondas', 
