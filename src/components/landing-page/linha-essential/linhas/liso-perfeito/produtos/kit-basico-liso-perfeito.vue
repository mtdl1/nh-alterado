<template>
    <div class="card">
        <div class="img-card position-relative">
            <a href="/kit-liso-perfeito-shampoo-condicionador-new-hair-home-care-essential.html">
                <img class="card-img-top" src="@/assets/img/linha-essential/linhas/liso-perfeito/produtos/kit-basico-liso-perfeito.jpg" alt="Imagem do Kit Básico New Hair Linha Essential Liso Perfeito" title="Kit Básico Liso Perfeito">
            </a>
            <div class="position-absolute desconto"> {{ (Math.floor(100 - (precoPor*100)/precoDe)) }}% OFF </div>
        </div>
        <div class="card-body">
            <div class="body-title">
                <p class="card-title">Kit Básico Liso Perfeito </p>
                <p class="card-subtitle">shampoo, condicionador, máscara e sérum</p>
            </div>
            <div class="price">
            ...
            <div v-if="$route.name == 'landing-page-essential'">
                <a href="/kit-liso-perfeito-shampoo-condicionador-new-hair-home-care-essential.html" class="btn-compra">Saiba mais</a>
            </div>
                    ...
                    this.$carrinho.add(tipo,itens,(success, response) => {
                        ...
                        if(success){
                            this.$fbAddToCart({ 
                                ...
                                currentProduct: 'Kit Básico Liso Perfeito', 
