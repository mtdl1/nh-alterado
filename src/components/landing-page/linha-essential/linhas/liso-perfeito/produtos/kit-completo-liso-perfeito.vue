<template>
    <div class="card">
        <div class="img-card position-relative">
            <a href="/kit-liso-perfeito-shampoo-condicionador-spray-mascara-new-hair-home-care-essential.html">
                <img class="card-img-top" src="@/assets/img/linha-essential/linhas/liso-perfeito/produtos/kit-completo-liso-perfeito.jpg" alt="Imagem do Kit Completo New Hair Linha Essential Liso Perfeito" title="Kit Completo Liso Perfeito">
            </a>
            <div class="position-absolute desconto"> {{ (Math.floor(100 - (precoPor*100)/precoDe)) }}% OFF </div>
        </div>
        <div class="card-body">
            <div class="body-title">
                <p class="card-title">Kit Completo Liso Perfeito </p>
                <p class="card-subtitle">shampoo, condicionador, spray e máscara</p>
            </div>
            <div class="price">
            ...
            <a href="/new-hair-home-care-essential-liso-perfeito.html" class="btn-compra" v-show="$route.name == 'landing-page-essential'">Saiba mais</a>
            <div v-show="$route.name != 'landing-page-essential'">
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <a href="/kit-liso-perfeito-shampoo-condicionador-spray-mascara-new-hair-home-care-essential.html" class="btn-saiba-single">SABER MAIS</a>
                </div>
            </div>
        </div>
    </div>
                    ...
                    this.$carrinho.add(tipo,itens,(success, response) => {
                        ...
                        if(success){
                            this.$fbAddToCart({ 
                                ...
                                currentProduct: 'Kit Completo Liso Perfeito', 
