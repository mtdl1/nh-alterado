<template>
    <div class="card">
        <div class="img-card position-relative">
            <a href="/kit-sos-reparacao-shampoo-condicionador-new-hair-home-care-essential.html">
                <img class="card-img-top" src="@/assets/img/linha-essential/linhas/sos-reparacao/produtos/kit-basico-sos-reparacao.jpg" alt="Imagem do Kit Básico New Hair Linha Essential S.O.S. Reparação" title="Kit básico S.O.S. reparacao" >
            </a>
            <div class="position-absolute desconto"> {{ (Math.floor(100 - (precoPor*100)/precoDe)) }}% OFF </div>
        </div>
        <div class="card-body">
            <div class="body-title">
                <p class="card-title">Kit Básico SOS Reparação </p>
                <p class="card-subtitle">shampoo e condicionador</p>
            </div>
            <div class="price">
            ...
            <div v-if="$route.name == 'landing-page-essential'">
                <a href="/kit-sos-reparacao-shampoo-condicionador-new-hair-home-care-essential.html" class="btn-compra">Saiba mais</a>
            </div>
                    ...
                    this.$carrinho.add(tipo,itens,(success, response) => {
                        ...
                        if(success){
                            this.$fbAddToCart({ 
                                ...
                                currentProduct: 'Kit Básico S.O.S Reparação', 
