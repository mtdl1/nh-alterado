<template>
    <div class="card">
        <div class="img-card position-relative">
            <a href="/condicionador-sos-reparacao-para-cabelos-danificados-new-hair-home-care-essential.html">
                <img class="card-img-top" src="@/assets/img/linha-essential/linhas/sos-reparacao/produtos/sos-reparacao-condicionador.jpg" alt="Imagem do condicionador New Hair Linha Essential S.O.S. Reparação" title="Condicionador S.O.S. reparação">
            </a>
            <div class="position-absolute desconto"> {{ (Math.floor(100 - (precoPor*100)/precoDe)) }}% OFF </div>
        </div>
        <div class="card-body">
            <div class="body-title">
                <p class="card-title">SOS Reparação Condicionador 250ml</p>
            ...
            <div v-if="$route.name == 'landing-page-essential'">
                <a href="/condicionador-sos-reparacao-para-cabelos-danificados-new-hair-home-care-essential.html" class="btn-compra">Saiba mais</a>
            </div>
                    ...
                    this.$carrinho.add(tipo,itens,(success, response) => {
                        ...
                        if(success){
                            this.$fbAddToCart({ 
                                ...
                                currentProduct: 'S.O.S Reparação Condicionador 250ml', 
