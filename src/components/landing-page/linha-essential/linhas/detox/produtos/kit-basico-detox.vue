<template>
    <div class="card">
        <div class="img-card position-relative">
            <a href="/kit-super-detox-shampoo-condicionador-new-hair-home-care-essential.html">
                <img class="card-img-top" src="@/assets/img/linha-essential/linhas/detox/produtos/kit-basico-detox.jpg" alt="Imagem do Kit Básico New Hair Linha Essential Super Detox" title="Kit Básico Super Detox">
            </a>
            <div class="position-absolute desconto"> {{ (Math.floor(100 - (precoPor*100)/precoDe)) }}% OFF </div>
        </div>
        <div class="card-body">
            <div class="body-title">
                <h5 class="card-title">Kit Básico Super Detox</h5>
            ...
            <div v-if="$route.name == 'landing-page-essential'">
                <a href="/kit-super-detox-shampoo-condicionador-new-hair-home-care-essential.html" class="btn-compra">Saiba mais</a>
            </div>
                    ...
                    this.$carrinho.add(tipo,itens,(success, response) => {
                        ...
                        if(success){
                            this.$fbAddToCart({ 
                                ...
                                currentProduct: 'Kit Básico Super Detox', 
