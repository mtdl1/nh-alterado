<template>
    <div class="card">
        <div class="img-card position-relative">
            <a href="/kit-super-detox-shampoo-condicionador-serum-reparador-new-hair-home-care-essential.html">
                <img class="card-img-top" src="@/assets/img/linha-essential/linhas/detox/produtos/kit-completo-detox.jpg" alt="Imagem do Kit Completo New Hair Linha Essential Super Detox" title="Kit Completo Super Detox">
            </a>
            <div class="position-absolute desconto"> {{ (Math.floor(100 - (precoPor*100)/precoDe)) }}% OFF </div>
        </div>
        <div class="card-body">
            <div class="body-title">
                <h5 class="card-title">Kit Completo Super Detox</h5>
                <p class="card-subtitle">shampoo, condicionador e sérum reparador</p>
            </div>
            <div class="price">
            ...
            <a href="/kit-super-detox-shampoo-condicionador-serum-reparador-new-hair-home-care-essential.html" class="btn-compra" v-show="$route.name == 'landing-page-essential'">Saiba mais</a>
            <div v-show="$route.name != 'landing-page-essential'">
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <a href="/kit-super-detox-shampoo-condicionador-serum-reparador-new-hair-home-care-essential.html" class="btn-saiba-single">SABER MAIS</a>
                </div>
            </div>
        </div>
    </div>
                    ...
                    this.$carrinho.add(tipo,itens,(success, response) => {
                        ...
                        if(success){
                            this.$fbAddToCart({ 
                                ...
                                currentProduct: 'Kit Completo Super Detox', 
