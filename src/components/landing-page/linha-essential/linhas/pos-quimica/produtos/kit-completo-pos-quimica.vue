<template>
    <div class="card">
        <div class="img-card position-relative">
            <a href="/kit-pos-quimica-shampoo-condicionador-mascara-new-hair-home-care-essential.html">
                <img class="card-img-top" src="@/assets/img/linha-essential/linhas/pos-quimica/produtos/kit-completo-pos-quimica.jpg" alt="Imagem do Kit Completo New Hair Linha Essential Pós Química" title="Kit Completo Pós Química">
            </a>
            <div class="position-absolute desconto"> {{ (Math.floor(100 - (precoPor*100)/precoDe)) }}% OFF </div>
        </div>
        <div class="card-body">
            <div class="body-title">
                <p class="card-title">Kit Completo Pós Química </p>
                <p class="card-subtitle">shampoo, condicionador e máscara</p>
            </div>
            <div class="price">
            ...
            <a href="/kit-pos-quimica-shampoo-condicionador-mascara-new-hair-home-care-essential.html" class="btn-compra" v-show="$route.name == 'landing-page-essential'">Saiba mais</a>
            <div v-show="$route.name != 'landing-page-essential'">
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <a href="/kit-pos-quimica-shampoo-condicionador-mascara-new-hair-home-care-essential.html" class="btn-saiba-single">SABER MAIS</a>
                </div>
            </div>
        </div>
    </div>
                    ...
                    this.$carrinho.add(tipo,itens,(success, response) => {
                        ...
                        if(success){
                            this.$fbAddToCart({ 
                                ...
                                currentProduct: 'Kit Completo Pós Química', 
