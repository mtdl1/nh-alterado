<template>
    <div class="card">
        <div class="img-card position-relative">
            <a href="/mascara-pos-quimica-para-cabelos-danificados-ressecados-quebradicos-new-hair-home-care-essential.html">
                <img class="card-img-top" src="@/assets/img/linha-essential/linhas/pos-quimica/produtos/pos-quimica-mascara.jpg" alt="Imagem da Máscara New Hair Linha Essential Pós Química" title="Kit Completo Pós Química">
            </a>
            <div class="position-absolute desconto"> {{ (Math.floor(100 - (precoPor*100)/precoDe)) }}% OFF </div>
        </div>
        <div class="card-body">
            <div class="body-title">
                <p class="card-title">Pós Química Máscara 250g</p>
            ...
            <div v-if="$route.name == 'landing-page-essential'">
                <a href="/mascara-pos-quimica-para-cabelos-danificados-ressecados-quebradicos-new-hair-home-care-essential.html" class="btn-compra">Saiba mais</a>
            </div>
                    ...
                    this.$carrinho.add(tipo,itens,(success, response) => {
                        ...
                        if(success){
                            this.$fbAddToCart({ 
                                ...
                                currentProduct: 'Pós Química Máscara 250g', 
