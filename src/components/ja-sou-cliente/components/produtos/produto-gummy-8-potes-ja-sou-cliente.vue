<template>
    <div class="box-produto mb-3 border-pink" id="ColagenoProd3">
        <div class="header-produto nome-produto d-flex flex-column justify-content-center pink">
            <h2>8 Potes New Hair Gummy</h2>
            <p class="pt-1">Brinde Escova Alisadora - TRATAMENTO 240 DIAS</p>
        </div>
        <div class="body-produto d-flex">
            <div class="col-produto w-50 d-flex justify-content-center align-items-center position-relative">
                ...
                <div class="d-flex">
                    ...
                    <img id="158" src="@/assets/img/produtos/gomas/kit-8/8 POTES DE GUMMY + ESCOVA ALISADORA.jpg" class="img-fluid img-produto" alt="8 Potes Gummy Uva - Laranja - Morango + Escova Alisadora title=8 Potes Gummy Uva - Laranja - Morango + Escova Alisadora" v-if="sabores == '0' || sabores == '158'">
                    <img id="159" src="@/assets/img/produtos/gomas/kit-8/8 POTES DE GUMMY MORANGO + ESCOVA ALISADORA.jpg" class="img-fluid img-produto" alt="8 Potes Gummy Morango - Morango - Morango + Escova Alisadora" title="8 Potes Gummy Morango - Morango - Morango + Escova Alisadora" v-if="sabores == '159'">
                    <img id="160" src="@/assets/img/produtos/gomas/kit-8/8 POTES DE GUMMY LARANJA + ESCOVA ALISADORA.jpg" class="img-fluid img-produto" alt="8 Potes Gummy Laranja + Escova Alisadora" title="8 Potes Gummy Laranja + Escova Alisadora" v-if="sabores == '160'">
                    <img id="161" src="@/assets/img/produtos/gomas/kit-8/8 POTES DE GUMMY UVA VERDE + ESCOVA ALISADORA.jpg" class="img-fluid img-produto" alt="8 Potes Gummy Uva Verde + Escova Alisadora" title="8 Potes Gummy Uva Verde + Escova Alisadora" v-if="sabores == '161'">
            ...
            <div class="col-produto w-50 pl-2">
                ...
                <div class="form-group select_sabores w-100 pr-3 my-1">
                    <select name="saboresColagProd3" class="select_option browser-default custom-select" id="saboresColagProd3" @change="onChange($event)" v-model="sabores">
                        ...
                        <option class="option" value="158">8 Potes - 4 Morango + 2 Uva + 2 Laranja</option>
                        <option class="option" value="159">8 Potes - Morango</option>
                        <option class="option" value="161">8 Potes - Uva Verde</option>
                        <option class="option" value="160">8 Potes - Laranja</option>
                    </select>
                </div>
                <div class="mt-2 pr-3">
