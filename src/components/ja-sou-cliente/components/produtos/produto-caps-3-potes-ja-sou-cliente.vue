<template>
	<div class="box-produto mb-3 border-black">
		<div class="header-produto nome-produto d-flex flex-column justify-content-center bgTitle">
			<h2>3 Potes New Hair Caps</h2>
			<p>Brinde Massageador - TRATAMENTO 90 DIAS</p>
		</div>
		<div class="body-produto d-flex">
			<div class="col-produto w-50 d-flex justify-content-center align-items-center position-relative">
				...
				<div class="d-flex">
					<img id="57" class="img-fluid" src="@/assets/img/produtos/caps/3 Potes caps.jpg" alt="3 Potes New Hair Cápsulas Femininas" title="3 Potes New Hair Cápsulas Femininas" />
				</div>
			</div>
                    ...
                    this.$carrinho.add(tipo,itens,(success, response) => {
                        ...
                        if(success){
													this.$fbAddToCart({ 
														...
														currentProduct: '3 Potes New Hair Caps', 
